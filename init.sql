PROMPT Creation des tables SET ECHO ON DROP TABLE Inscription;
...
CREATE TABLE Inscription (
	...
	dateAbandon DATE,
	note INTEGER,
	CONSTRAINT ClePrimaireInscription PRIMARY KEY (codePermanent,
		sigle,
		noGroupe,
		codeSession),
	CONSTRAINT CERefGroupeCours FOREIGN KEY (sigle,
		noGroupe,
		codeSession) REFERENCES GroupeCours,
	CONSTRAINT CECodePermamentRefEtudiant FOREIGN KEY (codePermanent) REFERENCES Etudiant
);

PROMPT Insertion de donnees pour les essais INSERT INTO Cours
